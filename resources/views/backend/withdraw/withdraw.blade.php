                        ...
                        <div class="row text-dark">
                          <div class="col-md-8 mr-auto ml-auto">
                            <div class="form-group">
                              <label for="message-text" class="col-form-label">Authorize:</label>
                              <select type="number" class="form-control" id="authorize">
                                  <option value="0">Pending</option>
                                  <option value="1">Approve</option>
                                  <option value="2">Reject</option>
                              </select>
                              <div class="invalid-feedback" id="authorize_msg">
                              </div>
                            </div>
                          </div>
                        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.26.0/axios.min.js" integrity="sha512-bPh3uwgU5qEMipS/VOmRqynnMXGGSRv+72H/N260MQeXZIK4PG48401Bsby9Nq5P5fz7hy5UGNmC/W1Z51h2GQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  ...
  <script src="{{asset('storage/assets/js/lib/data-table/datatables.min.js')}}"></script>
  <script src="{{asset('storage/adminlte/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js')}}"></script>

  @include('backend.withdraw.internal-assets.js.script')
  <script>
    function formSubmit(){
