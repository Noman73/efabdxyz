                                          ...
                                          <div class="member-view-box">
                                              <div class="member-image">
                                                  ...
                                                  <div class="status {{($owner==null ? 'text-danger' : 'text-success' )}}">
                                                    <i class="fa {{($owner==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                  </div>
                                                  ...
                                                  <div class="member-view-box">
                                                      <div class="member-image">
                                                          ...
                                                          <div class="status {{($left==null? 'text-danger' : 'text-success' )}}">
                                                            <i class="fa {{($left==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                           </div>
                                                          <div class="member-details">
                                                        ...
                                                        <div class="member-view-box">
                                                            <div class="member-image">
                                                                ...
                                                                <div class="status {{($second_level_left_hand_left_side==null? 'text-danger' : 'text-success' )}}">
                                                                  <i class="fa {{($second_level_left_hand_left_side==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                                </div>
                                                                <div class="member-details">
                                                          ...
                                                          <div class="member-view-box">
                                                              <div class="member-image">
                                                                  ...
                                                                  <div class="status {{($second_level_left_hand_right_side==null? 'text-danger' : 'text-success' )}}">
                                                                    <i class="fa {{($second_level_left_hand_right_side==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                                  </div>
                                                                  <div class="member-details">
                                                  ...
                                                  <div class="member-view-box">
                                                      <div class="member-image">
                                                          ...
                                                          <div class="status {{($right==null? 'text-danger' : 'text-success' )}}">
                                                            <i class="fa {{($right==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                           </div>
                                                          <div class="member-details">
                                                        ...
                                                        <div class="member-view-box">
                                                            <div class="member-image">
                                                                ...
                                                                <div class="status {{($second_level_right_hand_left_side==null? 'text-danger' : 'text-success' )}}">
                                                                  <i class="fa {{($second_level_right_hand_left_side==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                                </div>
                                                                <div class="member-details">
                                                        ...
                                                        <div class="member-view-box">
                                                            <div class="member-image">
                                                                ...
                                                                <div class="status {{($second_level_right_hand_right_side==null? 'text-danger' : 'text-success' )}}">
                                                                  <i class="fa {{($second_level_right_hand_right_side==null? 'fa-times-circle' : 'fa-check-circle' )}}"></i>
                                                                </div>
                                                                <div class="member-details">
