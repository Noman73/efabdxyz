...
class PackageController extends Controller
{
    ...
    {
        if (request()->ajax()){
            $get=Package::with('total_sale')->get();
          ...
          ->addColumn('total_sale',function($get){
            return $get->total_sale->count();
          })
    ...
    {
        $payment_method= Package::select('id','title')->where('title','like','%'.$request->searchTerm.'%')->take(15)->get();
